...
## [0.10.0](https://github.com/bhardwajRahul/lfk/compare/v0.9.35...v0.10.0) (2026-04-30)
...
* add 't' hotkey to toggle transparent background in colorscheme selector ([324e16d](https://github.com/bhardwajRahul/lfk/commit/324e16dac64bc9c2f62b2985eb24d66455bc77c1))
* add 21 colorschemes sourced from ghostty terminal themes ([e90a277](https://github.com/bhardwajRahul/lfk/commit/e90a277942f5a4466a946acec0f743e19b8628af))
* add allowed-only filter toggle to Can-I RBAC browser ([f3843f4](https://github.com/bhardwajRahul/lfk/commit/f3843f4b89750a8b209c1bcfb05cb7edc07b7a0e))
* add Argo Workflow details with steps, progress, and duration ([790c7ce](https://github.com/bhardwajRahul/lfk/commit/790c7cecfe0c0383dee0dc52d432176015619e6b))
* add argocd applyonly sync support, force finalize deletion support ([f2eab6c](https://github.com/bhardwajRahul/lfk/commit/f2eab6c8c02a75261199a26f95e7f0509fb0d5e6))
* add ArgoCD autosync configuration overlay ([a14c10d](https://github.com/bhardwajRahul/lfk/commit/a14c10d61b00a95a8334ee735e224e7dc8b4933c))
...
* add bulk sync, sync (apply only), and refresh for ArgoCD apps ([7b2699c](https://github.com/bhardwajRahul/lfk/commit/7b2699c5660e6f6b0cd5a20a0e08498f68cdef44))
...
* add color coding for Reason column in resource lists ([74bae44](https://github.com/bhardwajRahul/lfk/commit/74bae44241699201a6e07a0226f9ab53c8f84028))
* add color-coded pod prefixes in multi-pod log viewer ([e648a48](https://github.com/bhardwajRahul/lfk/commit/e648a4841db4ea672755a3c237b3be59a689a8ad))
* add configurable scrolloff setting used across all views ([e39a539](https://github.com/bhardwajRahul/lfk/commit/e39a5395fa166a32398b1ed45d35d47fe5e3bb47))
...
* add Ctrl+T hotkey to toggle terminal mode (pty/exec) in-app ([c95d846](https://github.com/bhardwajRahul/lfk/commit/c95d846e97a1b5cbab6f8c46eed66b64c086b19e))
...
* add cursor to diff view, Tab switches sides, fix fold toggle ([4a60d9a](https://github.com/bhardwajRahul/lfk/commit/4a60d9aff27306f7959101bbb678eb661065ffc8))
...
* add error log copy/fullscreen and unify delete for deleting pods ([29a7a66](https://github.com/bhardwajRahul/lfk/commit/29a7a6636d00cb1ab57aee8a9cc7f9ff982cda47))
* add finalizer search and remove ([b529155](https://github.com/bhardwajRahul/lfk/commit/b529155dc5dae1aeab4abb960ffce832cb982f3d))
* add flake.nix ([c90effc](https://github.com/bhardwajRahul/lfk/commit/c90effcf6503d09f62a85741d2aadce4aeddd2c5))
* add git pre-commit hook to ensure linting ([abbdec6](https://github.com/bhardwajRahul/lfk/commit/abbdec64a80f147f85aa4764c82d5d15bdf011d9))
* add global and local bookmark support (vim-style marks) ([7f3632b](https://github.com/bhardwajRahul/lfk/commit/7f3632b356eb31e0b67ec41e572a365540768228))
* add interactive kubectl explain API browser (I key) ([e4fd830](https://github.com/bhardwajRahul/lfk/commit/e4fd8305b332751b4cc9266d12b7afdb287451e8))
...
* add more consistent menu naming ([278a321](https://github.com/bhardwajRahul/lfk/commit/278a321ea631e8efba3eb1deefc5d58b75d2ca6e))
...
* add p hotkey to toggle pod/container prefixes in log viewer ([a9b7196](https://github.com/bhardwajRahul/lfk/commit/a9b7196f75b2efee5026d1b4317f322edac5f3c8))
* add Refresh action for ArgoCD ApplicationSets ([f733d18](https://github.com/bhardwajRahul/lfk/commit/f733d189f9714f8ab1b2814f2c4371c2d28f1b0c))
...
* add resource actions for KEDA, ESO, Argo Workflows, cert-manager, Helm, PVC, and vuln scan ([fb667b3](https://github.com/bhardwajRahul/lfk/commit/fb667b3592a0773f178dc131f3c2679a77a15ec0))
* add search and folding to diff view ([dba1fec](https://github.com/bhardwajRahul/lfk/commit/dba1fec4101249c4ddd328c0116f0d638d43f13c))
...
* add standalone debug pod action (b/B in action menu) ([9b7cc08](https://github.com/bhardwajRahul/lfk/commit/9b7cc084d9c1be8ddf5f8475042aef0ac03687f8))
* add support for argocd sync termination ([fa148e9](https://github.com/bhardwajRahul/lfk/commit/fa148e955b668f6514d3fce5a58aaad997d729a8))
* add support for custom columns, more sorting options ([ce62746](https://github.com/bhardwajRahul/lfk/commit/ce627462b896e7923d2de01c0bfe6bdfd17ec4f7))
...
* add template search filter and expand to 26 resource templates ([711baed](https://github.com/bhardwajRahul/lfk/commit/711baed7fff615630b8b7e7ec96291856d8c2581))
...
* add vim motions, visual selection, and cursor side switching to diff view ([34875e9](https://github.com/bhardwajRahul/lfk/commit/34875e9066afed8b55c3dc0fd9e3283d67d60147))
* add vim word motions (w/b/e) to YAML preview and log viewer ([be8de81](https://github.com/bhardwajRahul/lfk/commit/be8de81dcf4c799d384c889bc5faa09d6dafc05b))
* add visual line selection (v) and copy (y) in YAML view ([41f92d2](https://github.com/bhardwajRahul/lfk/commit/41f92d24e818159cc00e77948a676a64ce5d0f22))
...
* add Watch Workflow action for Argo Workflows with live auto-refresh ([2ace111](https://github.com/bhardwajRahul/lfk/commit/2ace11163b9081746208987fd29a0a868bba836f))
...
* add YAML syntax highlighting and fix yaml viewer scroll ([a67e902](https://github.com/bhardwajRahul/lfk/commit/a67e9028ede9e5a86260aa5f10abedf7dcbe5f40))
...
* bookmark enhancements, vim motions, PVC navigation, Can-I refactoring ([52944b3](https://github.com/bhardwajRahul/lfk/commit/52944b3228e859d7caa0bc1ba59f05e23cb5844b))
* Can-I browser discovers cross-namespace RoleBindings for service accounts ([484be82](https://github.com/bhardwajRahul/lfk/commit/484be82d2c660f856b14d896f20e7f9d53e33906))
* change copy YAML hotkey from Ctrl+Y to Y (shift+y) ([5f10e67](https://github.com/bhardwajRahul/lfk/commit/5f10e672031710effe8de9ca028cad95ec50edad))
* change mount path for pvc debug pods ([24ae081](https://github.com/bhardwajRahul/lfk/commit/24ae081be7ee5712338ab4cf15a283d59e5aa227))
* code restructuring and cleanup ([4421982](https://github.com/bhardwajRahul/lfk/commit/4421982132dbf1aa42eed4fd5cc61fab18465f73))
...
* context-aware help screen shows only current view's keybindings ([55f4900](https://github.com/bhardwajRahul/lfk/commit/55f4900c9a8ee63142be4d459708dc7db9933b3d))
* cursor to follow search match, on new search start searching from cursor position ([a136e3f](https://github.com/bhardwajRahul/lfk/commit/a136e3f2fb108875223613768423f168217c2349))
* disable autosync sub-options when off, show AutoSync column ([6bbc9c3](https://github.com/bhardwajRahul/lfk/commit/6bbc9c3c9cd253b604962dfabba87c2de4e563e7))
...
* don't show used by in pvc columns ([82868aa](https://github.com/bhardwajRahul/lfk/commit/82868aa129e464012b9c3d5d214d6a01d44b2c08))
...
* extract ArgoCD app conditions to DETAILS pane ([2a789ef](https://github.com/bhardwajRahul/lfk/commit/2a789efbcced21bb37245f78ec2388df4875479e))
...
* fix broken layout on logs viewer ([608b7ca](https://github.com/bhardwajRahul/lfk/commit/608b7ca0e89369bcdc2f990dd2f58830e1c64753))
* fix golangci-lint errors ([0d31648](https://github.com/bhardwajRahul/lfk/commit/0d316483fc878c83050cd851a85eb746c6fa6d17))
* fix quickfilters ([6138a7a](https://github.com/bhardwajRahul/lfk/commit/6138a7af8d1c5352482b0a88c70d41487e61d3b9))
...
* generate 462 colorschemes from ghostty themes and add transparent background option ([92dadfb](https://github.com/bhardwajRahul/lfk/commit/92dadfbcfedad3c6dcea0a3efa77494b125e66ae))
...
* log viewer enhancements, startup tips, lint fixes ([099804d](https://github.com/bhardwajRahul/lfk/commit/099804db38c2dbfa9ea87e4403f0b1985338e6bb))
...
* make all keybindings configurable via config.yaml ([441777f](https://github.com/bhardwajRahul/lfk/commit/441777fb14146040e1bbbcc74f5e7b5634064c27))
...
* monitoring config, API explorer, log viewer improvements, UX enhancements ([1c6247d](https://github.com/bhardwajRahul/lfk/commit/1c6247d49cbb4a443cf09c9289e07b5a78239375))
...
* PTY prefix key tab switching, right column layout, container filter, cursor stability, visual selection ([73362e8](https://github.com/bhardwajRahul/lfk/commit/73362e8ccfc609433eeb8a0cbc1df02c13899b13))
...
* require typing DELETE to confirm dangerous actions ([78f46b4](https://github.com/bhardwajRahul/lfk/commit/78f46b44c71cee41b9107f6c6cdb0a13c75ff33d))
...
* save autosync with enter, add AutoSync column color coding ([8c0dc94](https://github.com/bhardwajRahul/lfk/commit/8c0dc94c71b71e2dc0af474edd33a49f56868784))
...
* show additionalPrinterColumns ([c444f27](https://github.com/bhardwajRahul/lfk/commit/c444f273473790294ba94b928a9ef9f03a64dac0))
* show all conditions in details pane with color coding ([7908652](https://github.com/bhardwajRahul/lfk/commit/7908652b84f3c9f97881c736ecb425805a86f060))
...
* show event timeline in preview pane below resource usage ([4ca16a5](https://github.com/bhardwajRahul/lfk/commit/4ca16a50a96536951018cea284ac3db3bf3bc82a))
* show namespace scope in Can-I browser title bar ([caef181](https://github.com/bhardwajRahul/lfk/commit/caef1815e3e58773fb3ab6a53e9e4b23e1366e70))
...
* show OIDC users and groups in Can-I browser subject selector ([606855a](https://github.com/bhardwajRahul/lfk/commit/606855a329470b95e38b3eca2537afc00510af85))
* show owner chain upward for pods and containers in resource map ([7a40722](https://github.com/bhardwajRahul/lfk/commit/7a40722629dea63cf1ca492d445013821f8a803d))
* show sync start time in Synced At column for in-progress syncs ([9c1a732](https://github.com/bhardwajRahul/lfk/commit/9c1a732e5f506449288eb00ede84bae183667eb2))
* show Terminating status for resources with deletionTimestamp ([1fb3dd3](https://github.com/bhardwajRahul/lfk/commit/1fb3dd33c3430b9e770a07b9e1f439e0eef61629))
* sort events by lastseen ([7ca6d04](https://github.com/bhardwajRahul/lfk/commit/7ca6d045c389548f9b6e03845d4c1feecf3cfd16))
* sort resource templates to match current resource kind ([8bdbb1b](https://github.com/bhardwajRahul/lfk/commit/8bdbb1bb064dd0998b52d060fc1cbc54e297a2b0))
* stream all pods at once when opening logs for a deployment ([ca1b1cf](https://github.com/bhardwajRahul/lfk/commit/ca1b1cfd3ae638b66cbfc322c16bc0766e1ae82d))
...
* update deletion logic for pods ([e9be4f9](https://github.com/bhardwajRahul/lfk/commit/e9be4f939a243c626fcb0010da8eff18de99f659))
* update go version to 1.26.2 ([3ec2b00](https://github.com/bhardwajRahul/lfk/commit/3ec2b009d30b673d0e965d450632cdea6113d58b))
* update linters ([768565e](https://github.com/bhardwajRahul/lfk/commit/768565eab7e9c61815e6d4a0249b1fd56b714ee1))
* update max tabs to 9 ([b2e844a](https://github.com/bhardwajRahul/lfk/commit/b2e844aa22e68fb406e2909c2174e7dd8eb74847))
* update to go 1.26.1 ([a1daef7](https://github.com/bhardwajRahul/lfk/commit/a1daef7f25e44df75f294367f368ad62ec8d89de))
* vim word motions (w/b/e/0/$) work in visual selection mode ([b48184a](https://github.com/bhardwajRahul/lfk/commit/b48184a5bc9cc1498630818bd4e92ecfe1547207))
* vim word motions jump between lines in YAML preview and log viewer ([a4ef89f](https://github.com/bhardwajRahul/lfk/commit/a4ef89ff906f1b95d27fe1db89d8df626cdc5b62))
...
* add --ignore-errors to log streams for init container support ([c65c251](https://github.com/bhardwajRahul/lfk/commit/c65c2516927a3eb343591868d557ec739384c6db))
...
* also check resource type for ApplicationSet refresh dispatch ([cc1760f](https://github.com/bhardwajRahul/lfk/commit/cc1760f18148c78558475d83933d3608762997b0))
* always show Condition column regardless of item threshold ([01af309](https://github.com/bhardwajRahul/lfk/commit/01af309bf25635e669a5dcdb1c3d60aa25d3bc30))
...
* apply FillLinesBg to all overlay content, help screen, and error log ([22c7a9a](https://github.com/bhardwajRahul/lfk/commit/22c7a9acc5cd44c6804211a625601d8f3c8506e4))
* apply theme background to all inline styles and fix last-item in column view ([603dd2e](https://github.com/bhardwajRahul/lfk/commit/603dd2e20d21b0e3291205300dc49c29be0edd25))
* apply theme background to all text styles, not just containers ([e701d7d](https://github.com/bhardwajRahul/lfk/commit/e701d7d7374d42a32aa9a39d6ffaa40dccc6b076))
* apply theme background to columns/overlays and fix last resource cutoff ([d5f7d93](https://github.com/bhardwajRahul/lfk/commit/d5f7d930e6df20149220fb4a87a1dcb14a06ea47))
* apply theme background to tab bar, overlay borders, and status bar hints ([10b2e09](https://github.com/bhardwajRahul/lfk/commit/10b2e09196fd7149c1261e3813789ff11373b70a))
* apply theme background to title bar, status bar, borders, and all text styles ([cbd9524](https://github.com/bhardwajRahul/lfk/commit/cbd9524777908adf46fab3927af63d0e1ed2ee54))
* apply True-condition priority in extractStatus for STATUS column ([d10158b](https://github.com/bhardwajRahul/lfk/commit/d10158b3e247d954fd095c36a412ec5f17b7528f))
...
* ArgoCD sync clears stale syncStrategy from operationState before syncing ([461769c](https://github.com/bhardwajRahul/lfk/commit/461769ca0b9a22d0c537a58451eaf95180bceedd))
* ArgoCD sync uses Update instead of merge patch to avoid stale strategy keys ([0dc4b34](https://github.com/bhardwajRahul/lfk/commit/0dc4b3438b6fa5e244d0853eb743a6f1bbdf4c72))
...
* Can-I browser not showing namespaced role permissions for service accounts ([0f46cc8](https://github.com/bhardwajRahul/lfk/commit/0f46cc8fe0f3dd2249a665ff4269dced6f8f3451))
* Can-I browser overlay size jumping when switching subjects ([bb1a7be](https://github.com/bhardwajRahul/lfk/commit/bb1a7be284bf4cc4164a967c84c4d84d3d450093))
...
* closing intermediate tab no longer corrupts surviving tabs ([621d7ae](https://github.com/bhardwajRahul/lfk/commit/621d7ae15bbaebc570ef71d03b2663306f61a0da))
...
* consistent gg/G and 123G across all views ([ebcdfa1](https://github.com/bhardwajRahul/lfk/commit/ebcdfa17cccec6e43d98ffa20b6c823fc62e70f0))
* correct ESO reason values from upstream source code ([9c8c8a5](https://github.com/bhardwajRahul/lfk/commit/9c8c8a50d2fcdebbba4fbd14e106a30fb38fd985))
...
* daily tips with hotkey inconsistencies ([58b34ed](https://github.com/bhardwajRahul/lfk/commit/58b34ed54abc6885547cf47ce24a795c57f3e09c))
* debug pod hotkey b/B swap, fix kubectl explain for non-core resources ([89d60ae](https://github.com/bhardwajRahul/lfk/commit/89d60ae5002778974528a634a877c32ac5115451))
* deduplicate Status/Phase columns in CRD resource lists ([512b47d](https://github.com/bhardwajRahul/lfk/commit/512b47dddcd031aaec2c214a738dc6d0c5b26c57))
...
* diff fold placeholder shown in both panes with cursor and highlight ([16be0b3](https://github.com/bhardwajRahul/lfk/commit/16be0b33db18de3494c00c6f36503cddb99b3f58))
* diff search scoped to active pane and cursor jumps to match column ([503df7e](https://github.com/bhardwajRahul/lfk/commit/503df7e027d7411a8451cc1cd5a8fa62e19087d0))
* diff view cursor rendering and fold collapse cursor positioning ([ea9369e](https://github.com/bhardwajRahul/lfk/commit/ea9369e776624ce62abbde1dd20554c49df8d461))
* diff view cursor stays within visible area in both modes ([85346cc](https://github.com/bhardwajRahul/lfk/commit/85346cc3d22231d7cde6967ed8de05fff0c06697))
* diff view visible lines calculation matches renderer per mode ([a1163f0](https://github.com/bhardwajRahul/lfk/commit/a1163f017119d1914e4ec73469f2e6474a1e5b98))
...
* enable resource map for all kinds, refresh on cursor move, add Keys column ([b5dd2ea](https://github.com/bhardwajRahul/lfk/commit/b5dd2ea87398a64e393973e5c7434b8d53e28c49))
...
* extra columns no longer steal width from resource names ([e4dd3bb](https://github.com/bhardwajRahul/lfk/commit/e4dd3bbf6f47f4504e82d09fe51394eebb88dae7))
* fall back to generic condition extraction when no Ready condition ([e93a35d](https://github.com/bhardwajRahul/lfk/commit/e93a35db8f87c81a6db9b3ac1826d6201087f125))
* fill theme background across entire column/bar content with FillLinesBg ([896ebf7](https://github.com/bhardwajRahul/lfk/commit/896ebf7cb11bc87ba4feb4c1ed19a4e017ba4dc8))
...
* help screen theme consistency and stable window height ([d6b3ca8](https://github.com/bhardwajRahul/lfk/commit/d6b3ca88856c961c4a8eacc3f213293646594134))
...
* hide Deletion column from table and fix template overlay UX ([ae32ece](https://github.com/bhardwajRahul/lfk/commit/ae32eceefe5870bbb2b609aef7750b5314165187))
* hide Hostname/InternalIP/ExternalIP from normal node view ([ac0f07a](https://github.com/bhardwajRahul/lfk/commit/ac0f07a2ca8fc5ee055057959d1563e3c7b4e50f))
* hide OS/Runtime columns in normal node view, add separator in details ([8508840](https://github.com/bhardwajRahul/lfk/commit/85088408e1b322afb90b5ee521ab1c1013de649b))
* hide Service selectors from table, show as table in details pane ([2629ce3](https://github.com/bhardwajRahul/lfk/commit/2629ce3eb999bf3776c8e3b0f2e53246bf4bfc63))
...
* hide Taints from normal node view to prevent line wrapping ([2137e15](https://github.com/bhardwajRahul/lfk/commit/2137e151bcf6f4e69dba828423c6f47ca1012f00))
...
* improve template selector highlight and remove grouping ([08afc6f](https://github.com/bhardwajRahul/lfk/commit/08afc6f74d0d9881fc7108c306988ccd7313e332))
* include Status and column values in filter search text ([3d455c2](https://github.com/bhardwajRahul/lfk/commit/3d455c2586f53a6b0e114c5c6317637caf4ef4d9))
* init container status showing Running instead of Completed ([4038856](https://github.com/bhardwajRahul/lfk/commit/403885680b3bba49670c7ecea2466074990e4797))
* intra-line search matches and YAML fold prefix column offset ([b90a598](https://github.com/bhardwajRahul/lfk/commit/b90a598b2c42ff82600c9e8685559dfca9c63fa7))
...
* jump cursor column to search match position in log viewer ([0ce1a30](https://github.com/bhardwajRahul/lfk/commit/0ce1a3011d13ee29841ac4e88629f6019e7eca57))
...
* local bookmarks no longer save cluster context ([4cd0f6f](https://github.com/bhardwajRahul/lfk/commit/4cd0f6f6acb32c84328dadbe298ec44ebd8458c1))
* log streaming consistency, binary char sanitization, theme background gaps ([a501d27](https://github.com/bhardwajRahul/lfk/commit/a501d2772ccf191f597d15ace37122177a8f5114))
* log viewer wrap mode clipping last lines, add dependency docs ([dc62efb](https://github.com/bhardwajRahul/lfk/commit/dc62efb9d347dd044428ab3cc8eafdd34ef6e109))
...
* lower diff fold threshold to 4 unchanged lines with 1 context ([3bf418b](https://github.com/bhardwajRahul/lfk/commit/3bf418bf6e2d9b2523eae889dd0cf0cdc97ec228))
...
* move cursor to fold header when collapsing a yaml section ([9d831d4](https://github.com/bhardwajRahul/lfk/commit/9d831d4153e9d07187ad0a46bf06792b0d0734e3))
...
* order workflow watch nodes by DAG execution order ([ce3c8ab](https://github.com/bhardwajRahul/lfk/commit/ce3c8ab2f8f5f6eac55561800ee704e0d9d239b8))
* panic on vim b/w/e word motions when cursor exceeds line length ([9a8bd46](https://github.com/bhardwajRahul/lfk/commit/9a8bd4629af58d0129a6397b7e7c9168dcde6cac))
* pinned resource categories are not shown on top ([1416836](https://github.com/bhardwajRahul/lfk/commit/141683694ae09c34e2a0663bea31537a73d87aab))
...
* prefer True conditions over inactive negative conditions ([5c9f8fa](https://github.com/bhardwajRahul/lfk/commit/5c9f8fa16bf2b215897a16170f580ac2b5b49b10))
...
* prevent bookmark corruption from slice backing-array mutation ([ccab918](https://github.com/bhardwajRahul/lfk/commit/ccab918c5f8c0be8e21b2e5a1196809bab11fc3f))
* prevent bookmark loss with atomic writes and defensive copies ([fc46e1c](https://github.com/bhardwajRahul/lfk/commit/fc46e1c1cda3d09af78c0df477ac2ae6a9135a54))
* prevent bookmark loss with atomic writes and defensive copies ([988c23c](https://github.com/bhardwajRahul/lfk/commit/988c23cc801d4e7c0f898a4b8714593973ffaf5a))
* prevent log viewer bottom border break on long wrapped lines ([db413b4](https://github.com/bhardwajRahul/lfk/commit/db413b4cac104f674c7da56cc15ffd5babf1d0b8))
* re-apply filter preset on owned resource watch refresh ([a5b55f4](https://github.com/bhardwajRahul/lfk/commit/a5b55f4c441a59a5b9ba95bf7cc4ec05f103a9c0))
* re-establish theme background after every ANSI reset within lines ([7d1ea67](https://github.com/bhardwajRahul/lfk/commit/7d1ea678d6e1acf6a9e89d0dcc96f61ffcbdda01))
* redirect bookmark delete tests to temp dir to prevent data loss ([9804f6d](https://github.com/bhardwajRahul/lfk/commit/9804f6d4ab3112c036b4099229b12c4f0e1cf378))
* reduce content height by 1 to prevent last item clipping ([d24388b](https://github.com/bhardwajRahul/lfk/commit/d24388b395221bcb61ef83ee97df541eae601590))
...
* remove AppSet refresh, add tab clicking, fix annotation deletion ([a27c1a1](https://github.com/bhardwajRahul/lfk/commit/a27c1a1b11db4896154e5cbb4091a09b70ded48f))
* remove barBg from HelpKeyStyle and fill title/status bars with FillLinesBg ([df44b38](https://github.com/bhardwajRahul/lfk/commit/df44b38d21eab2af4087812ee005dbde48d85aad))
...
* remove duplicate SyncError condition, show full Sync Errors ([e8f6731](https://github.com/bhardwajRahul/lfk/commit/e8f6731bba25028bd285709fd7c3e144d67ddaf4))
...
* remove Images column from ArgoCD application details ([91218df](https://github.com/bhardwajRahul/lfk/commit/91218df6a7d8c96bcf5fff41abb2930cf93f7f98))
* remove redundant ArgoCD Health/Sync columns, restrict AutoSync to Applications ([ade248b](https://github.com/bhardwajRahul/lfk/commit/ade248b3c8382cf88870f1733bc65380ac1bc295))
* remove s (exec) and r (restart) direct hotkeys ([810e968](https://github.com/bhardwajRahul/lfk/commit/810e968b275403b0167486d8029dd02c1a92194d))
...
* resource map indentation, background, and generic CRD support ([0290bca](https://github.com/bhardwajRahul/lfk/commit/0290bca9b8ff2659c831b04635511178124d2c57))
* restore explorer content height to match fullscreen views ([1ee1392](https://github.com/bhardwajRahul/lfk/commit/1ee1392e434974f2a82098f78269456b8c7c1ab5))
* restore Taints column, deduplicate ArgoCD columns, uppercase headers ([dadae10](https://github.com/bhardwajRahul/lfk/commit/dadae10870de4abd23baa579640350d1c550a1b6))
...
* scale and restart now work for StatefulSets, DaemonSets, ReplicaSets ([6891b9b](https://github.com/bhardwajRahul/lfk/commit/6891b9b100e9d342fc9e6ec8704342ae7f2a401b))
...
* search cursor jumps to match column in log viewer and YAML view ([46d9696](https://github.com/bhardwajRahul/lfk/commit/46d96964353284dc70bce2eaec4a8d2d9bf4b548))
* search for argocd managed resources by apiversion and kind, not just kind ([145aa23](https://github.com/bhardwajRahul/lfk/commit/145aa23aa480a8455b33adc54b89621784e1e45a))
...
* show ArgoCD condition types in table column, full messages in details only ([786fa6a](https://github.com/bhardwajRahul/lfk/commit/786fa6a81eb516900c2e64d90e13b75dbd8dbb5d))
* show Completed status for finished init containers instead of Terminated ([c6a1dee](https://github.com/bhardwajRahul/lfk/commit/c6a1deea293f3e00341b3a89fd23dcdd23aa3851))
* show help overlay on top of fullscreen views instead of replacing them ([7b0ebc3](https://github.com/bhardwajRahul/lfk/commit/7b0ebc3f8b58891914500e19d672b3871d93d1b4))
* show help search in bottom status bar instead of inside overlay ([d4d7c92](https://github.com/bhardwajRahul/lfk/commit/d4d7c92eb814974d0ec2a05e2554c960910c8178))
...
* show overlay hint bar in fullscreen views (logs, YAML, etc.) ([04d79af](https://github.com/bhardwajRahul/lfk/commit/04d79af4b9444f3e1fb07ebd2ee11bdfef96e385))
* show resource name in DETAILS header and prevent column overlap ([a2eb74e](https://github.com/bhardwajRahul/lfk/commit/a2eb74ef929eb750121dbffec600862dc2e40e96))
* show search/filter bar inside help overlay instead of behind it ([df84e1f](https://github.com/bhardwajRahul/lfk/commit/df84e1fdd65284a7c49c1641f5a543ad1529566a))
* show Synced At before Sync Message in ArgoCD details ([f52482b](https://github.com/bhardwajRahul/lfk/commit/f52482ba87977252a96644b9397f4a3c401373c8))
* show Taints as multi-line field in details pane ([ab1b3e3](https://github.com/bhardwajRahul/lfk/commit/ab1b3e32159979ec1d950fb58e0862c56cc5d19a))
* skip Deletion column from regular rows to prevent duplicate ([8fe5af3](https://github.com/bhardwajRahul/lfk/commit/8fe5af371e389f52d66fe2999fa12522e976b26e))
* skip empty lines when copying from diff view active side ([662ea8e](https://github.com/bhardwajRahul/lfk/commit/662ea8e5905a2a9cd13f8ef6c19e9e9561864cf8))
...
* sort Argo Workflow steps by execution order instead of name ([02e7c33](https://github.com/bhardwajRahul/lfk/commit/02e7c3371eb9846d0467b6afbc3ce3d701b86632))
...
* stabilize template overlay height during scrolling ([96b8d43](https://github.com/bhardwajRahul/lfk/commit/96b8d43b37250440a8c1d2dbf6176cfaefa00f04))
* stable theme selector size, ANSI-aware truncation, and vim hotkeys ([5375991](https://github.com/bhardwajRahul/lfk/commit/537599120745d0e0a6c71d4b00f31bf7886aa436))
* store conditions on Item.Conditions instead of as cond: columns ([a0c1c4c](https://github.com/bhardwajRahul/lfk/commit/a0c1c4c648f9b2d744e60153a521e8683c62cb7e))
* store port-forward state ([efe3b98](https://github.com/bhardwajRahul/lfk/commit/efe3b9888c472e9738ff097d562e3893d72eb2fb))
* surface port forward errors in application log (! hotkey) ([0039267](https://github.com/bhardwajRahul/lfk/commit/0039267a531d75acba9a6acae1fd735d4f628c67))
* switch default theme to tokyonight-storm, unify bar backgrounds ([7e9a250](https://github.com/bhardwajRahul/lfk/commit/7e9a2500cab28a07599a66fb819568eb4c1bb7e5))
* switch to previous tab when closing a tab ([04bdb52](https://github.com/bhardwajRahul/lfk/commit/04bdb529e6017c8e5779db6c5fa2efed095375ed))
* theme selector stable size by counting header lines correctly ([d3b571d](https://github.com/bhardwajRahul/lfk/commit/d3b571de9c5ebab370a083d76e0b16558a8728b7))
* truncate Condition column to 15 chars with ~ marker ([44122c9](https://github.com/bhardwajRahul/lfk/commit/44122c9c181e6c104d01dc8eb600ec0f9ceca31f))
* truncate Condition column value to 30 chars ([c222487](https://github.com/bhardwajRahul/lfk/commit/c222487d84b456b8f9754bf6be3635ead9488660))
...
* unified diff view cursor stays within visible area ([b77a6f9](https://github.com/bhardwajRahul/lfk/commit/b77a6f922d58a2e9c9f8366e66e7f64ef77325e0))
...
* use full terminal height for help overlay in fullscreen views ([3da54c4](https://github.com/bhardwajRahul/lfk/commit/3da54c4a21ddb1bec3551b4d2aecff277cc14844))
* use rendering line map for accurate mouse click targeting ([6bec64c](https://github.com/bhardwajRahul/lfk/commit/6bec64c867c0902aa4bbbd9680755b5da633a774))
* use vim-style scrolloff for colorscheme selector scrolling ([111ab09](https://github.com/bhardwajRahul/lfk/commit/111ab09f43736b42549cb676466d9b921aaacd6b))
* visual selection first character not included and upward selection ([0e768af](https://github.com/bhardwajRahul/lfk/commit/0e768afdde1f58721402af9fadfe3e5a89d4e30a))
* workflow step order via DAG, remove map newline, find owned secrets ([89df6ff](https://github.com/bhardwajRahul/lfk/commit/89df6ff41b2c8f9fa328a575c6cd1dbef8cf7acf))
* wrap all detail row values including status and sync rows ([cfc0216](https://github.com/bhardwajRahul/lfk/commit/cfc021669e9428e7f5171ee7e525f7d062b29dd5))
* wrap long detail values instead of truncating ([6b0630b](https://github.com/bhardwajRahul/lfk/commit/6b0630bc6eee3cf1723d5da98eae3ac4cdc80a79))
